				...
				<div id="edit" style="margin-left:25px;margin-right:25px;">
					<form>
						<div class="form-group row">
							...
							<div class="col-lg-9">
								<input class="form-control" type="text" value="<?php echo $user['Name'];?>"disabled>
							</div>
						</div>
						...
						<!-- <div class="form-group row">
							...
							<div class="col-lg-9">
								<input class="form-control" type="text" value="Sonar"disabled>
							</div>
						</div> -->
						...
						<div class="form-group row">
							...
							<div class="col-lg-9">
								<input class="form-control" type="text" value="<?php echo $user['Mobile'];?>" disabled>
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-lg-9">
								<input class="form-control" type="email" value="<?php echo $user['Email'];?>" disabled>
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-lg-4">
								<input class="form-control" type="text" value="<?php echo $user['ResidentialArea'];?>" placeholder="Area"disabled>
							</div>		
						</div>
						...
						<div class="form-group row">
                            ...
                            <div class="col-lg-9">
								<center> 
									...
									<a href="user-update-profile.php">
