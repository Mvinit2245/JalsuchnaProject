...
<body>
    ...
    <div id="wrapper">
        ...
        <header class="topbar-nav">
            <nav class="navbar navbar-expand gradient-winter" style=" background: #ffffff; ">
        ...
        <div class="content-wrapper">
            ...
            <!--End Row-->
            <!--👀👀👀 for news input from the admin -->
            <!-- <h4> <small>Enter Blog to Display to the User.</small></h4> -->
            ...
            <!--👀👀👀 "END OF".......for news input from the admin -->
