                            ...
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item">
                                    <a href="javaScript:void();">
                                        <div class="media">
                                            <div class="avatar"><img class="align-self-start mr-3"
                                                    src="assets/images/" alt="user avatar"></div>
                                            <div class="media-body">
                                ...
                                <a href="javaScript:void();">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <p class="user-subtitle">jayy@example.com</p>
                                        </div>
                                    </div>
                                </a>
                            </li>
                    ...
                    <div id="edit" style="margin-left:25px;margin-right:25px;">
                        <form>
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input class="form-control" type="text" value="<?php echo $admin['AdminID'];?>" disabled>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-3 col-form-label form-control-label">Name</label>
                                <div class="col-lg-9">
                                    <input class="form-control" type="text" value="<?php echo $admin['Name'];?>" disabled>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input class="form-control" type="email"value="<?php echo $admin['Mobile'];?>" disabled>
                                </div>
                            </div>
