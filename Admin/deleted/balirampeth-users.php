...
<!-- Mirrored from codervent.com/rocker/demo/home.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Dec 2020 10:31:05 GMT -->
    ...
    <div id="wrapper">
                ...
                <ul class="navbar-nav align-items-center right-nav-link">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right">
                            ...
                            <li class="dropdown-divider"></li>
                            <li class="dropdown-item"><a href="#"><i class="icon-power mr-2"></i> Logout</li>
                        </ul>
                    </li>
                </ul>
            </nav>
        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                ...
                <h4 style="color:rgb(41, 53, 214) ;">Baliram Peth Users List </h4>
                <hr
