...
<body>
   ...
   if(isset($_GET['adm_id']))
   {
   	...
   	$view=mysqli_query($x,"select * from ad_form where adminID='".$_GET['adm_id']."'") or die(mysqli_error($x));
	 	$fetch=mysqli_fetch_array($view);
	 	extract($fetch);
   }
   ?>
                            <div class="form-group row">
                                <label class="col-lg-3 col-form-label form-control-label">AdminID</label>
                                <div class="col-lg-9">
                                    <input class="form-control" name="ad_id" type="text" value="<?php echo $admin['AdminID'];?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-3 col-form-label form-control-label">Name</label>
                                <div class="col-lg-9">
                                    <input class="form-control" name="ad_name" type="text" value="<?php echo $admin['Name'];?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input class="form-control" name="ad_mail" type="text" value="<?php echo $admin['Email'];?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input class="form-control" name="ad_mob"  value="<?php echo $admin['Mobile'];?>">
                                </div>
                            </div>
...
$update=mysqli_query($x,"update ad_form set
AdminID='".$ad_id."',
Name='".$d_name."',
Email='".$ad_mail."',
Mobile='".$ad_mob."'
where AdminID='".$_GET['adm_id']."'") or die(mysqli_error($x));
if($update)
{
