                        ...
                        <div class="row">
                                ...
                                <div class="pricing-table pricing-table-color">
                                    <div class="card gradient-scooter">
                                        <div class="card-body text-center">
                                            <div class="price-title text-white" style="font-size:25px">Shani Peth
                                            </div>


                                            <a href="shanipeth-users.php"
                            ...
                            <div class="col-12 col-lg-6 col-xl-3">
                                <div class="pricing-table pricing-table-color">
                                    <div class="card gradient-scooter">
                                        <div class="card-body text-center">
                                            <div class="price-title text-white" style="font-size:25px">Navi Peth
                                            </div>


                                            <a href="navipeth-users.php"
                                                class="btn btn-link text-info bg-white my-3 btn-round">Users</a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-12 col-lg-6 col-xl-3">
                                <div class="pricing-table pricing-table-color">
                                    <div class="card gradient-scooter">
                                        <div class="card-body text-center">
                                            <div class="price-title text-white" style="font-size:25px">Kanchan Nagar
                                            </div>


                                            <a href="kanchan-nagar-users.php"
                                                class="btn btn-link text-info bg-white my-3 btn-round">Users</a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-12 col-lg-6 col-xl-3">
                                <div class="pricing-table pricing-table-color">
                                    <div class="card gradient-scooter">
                                        <div class="card-body text-center">
                                            <div class="price-title text-white" style="font-size:25px">Shivaji Nagar
                                            </div>


                                            <a href="shivaji-nagar-users.php"
                                                class="btn btn-link text-info bg-white my-3 btn-round">Users</a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-12 col-lg-6 col-xl-3">
                                <div class="pricing-table pricing-table-color">
                                    <div class="card gradient-scooter">
                                        <div class="card-body text-center">
                                            <div class="price-title text-white" style="font-size:25px">Baliram Peth
                                            </div>


                                            <a href="balirampeth-users.php"
                                                class="btn btn-link text-info bg-white my-3 btn-round">Users</a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-12 col-lg-6 col-xl-3">
                                <div class="pricing-table pricing-table-color">
                                    <div class="card gradient-scooter">
                                        <div class="card-body text-center">
                                            <div class="price-title text-white" style="font-size:25px">Jainabad</div>


                                            <a href="jainabad-users.php"
                                                class="btn btn-link text-info bg-white my-3 btn-round">Users</a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-12 col-lg-6 col-xl-3">
                                <div class="pricing-table pricing-table-color">
                                    <div class="card gradient-scooter">
                                        <div class="card-body text-center">
                                            <div class="price-title text-white" style="font-size:25px">Mehrun
                                            </div>


                                            <a href="mehrun-users.php"
                                                class="btn btn-link text-info bg-white my-3 btn-round">Users</a>
                                        </div>
                                    </div>
                                </div>
