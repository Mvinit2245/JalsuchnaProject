...
<body>
    ...
    <div id="wrapper">
        ...
        <header class="topbar-nav">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    <ul class="list-group list-group-flush">
                       ...
                       <!-- <li class="list-group-item">
						...
						-->
                       <li class="list-group-item"><a href="user-notification.html">See All Notifications</a></li>
                    </ul>
                </div>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link dropdown-toggle dropdown-toggle-nocaret waves-effect" href="user-view-profile.html" >
