...
<div class="form-group row">
        <label class="col-lg-3 col-form-label form-control-label" ><b>ValvemenID</b></label>
        <div class="col-lg-9">
            <input class="form-control" type="text" value="<?php echo $valman['ValvemenID'];?>" disabled>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-lg-9">
            <input class="form-control" type="text" value="<?php echo $valman['Name'];?>" disabled>
        </div>
    </div>
    
    
    <div class="form-group row">
        <label class="col-lg-3 col-form-label form-control-label"><b>Mobile</b></label>
        <div class="col-lg-9">
            <input class="form-control" type="text" value="<?php echo $valman['Mobile'];?>" disabled>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-lg-9">
            <input class="form-control" type="email"value="<?php echo $valman['Email'];?>" disabled>
        </div>
    </div>
    ...
    <!-- <div class="form-group row">
        ...
        <div class="col-lg-9">
            <input class="form-control" type="text" value="In front of Ashtbhuja Temple, Samarth Nagar, Jalgaon" disabled>
        </div>
    </div> -->
    ...
    <div class="form-group row">
        ...
        <div class="col-lg-4">
            <input class="form-control" type="text" value="<?php echo $valman['ResidentialArea'];?>" disabled>
        </div>		
    </div>
