    ...
    <div id="wrapper">
        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">				
						 <h6 class="text-uppercase mt-3">People that live in Shani Peth area... </h6>
							<hr>
                            ...
                            <div class="table-responsive">
                                <table class="table align-items-center table-flush">
                                    ...
                                    <?php
					include "join.php";
					$view = mysqli_query($x,"SELECT * FROM `user_form` WHERE `ResidentialArea` LIKE 'Shani Peth'") or die (mysqli_error($x));
