...
<body>
    ...
    <div id="wrapper">
        ...
        <header class="topbar-nav">
            <nav class="navbar navbar-expand gradient-winter">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    <ul class="list-group list-group-flush">
						...
						-->
                        <li class="list-group-item"><a href="citizen_notifications.html">See All citizen_notifications</a></li>
                    </ul>
                </div>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link dropdown-toggle dropdown-toggle-nocaret waves-effect" href="valvemen_viewprofile.html" >
        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                ...
                <h3>Users List For Notification</h3>
                <div class="row">
                    <div class="col-lg-12">				
						 <h6 class="text-uppercase mt-3">People that live in Shivaji Nagar area... </h6>
							<hr>
                            ...
                            <div class="table-responsive">
                                <table class="table align-items-center table-flush">
                                    ...
                                    <?php
					include "join.php";
					$view = mysqli_query($x,"SELECT * FROM `user_form` WHERE `ResidentialArea` LIKE 'Shivaji Nagar'") or die (mysqli_error($x));
				...
				<?php } ?>
                <hr>
          <!-- <h5 class="text-uppercase mt-3" id="users">Users Information </h5>
		  <hr> -->
		    ...
		    <!-- <div class="table-responsive">
                                <table class="table align-items-center  table table-striped  shadow-dark table-bordered" >
                                    <thead >
                                        <tr >
                                            <th style="font-size:14px"><center>Name</center></th>
                                            <th style="font-size:14px"><center>Email ID</center></th>
                                            <th style="font-size:14px"><center>Mobile no.</center></th>
											<th style="font-size:14px"><center>Residental Area</center></th>
											<th style="font-size:14px"><center>Sub Area</center></th>    
                                        </tr>
                                    </thead>
									
                                    <tr >
										<td><center>Durvankur</center></td>
										<td><center>itsdurva194@gmail.com </center></td>
										<td><center>7588339660</center></td>
										<td><center>Baliram peth</center></td>
										<td><center>Behind Brahman Sabha</center></td>
                                    </tr>

                                    <tr >
										<td><center>VINIT</center></td>
										<td><center>itsdurva194@gmail.com </center></td>
										<td><center>7588339660</center></td>
										<td><center>Baliram peth</center></td>
										<td><center>Behind Brahman Sabha</center></td>
