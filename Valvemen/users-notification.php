...
$mail->SMTPAuth = true;
$mail->Username = 'vaibhavdaivadnya17@gmail.com';
$mail->Password = 'pdgbdqxtjeunidkp';
$mail->SMTPSecure = 'tls';
$mail->Port = 587;

// Set up the email message
$mail->setFrom('vaibhavdaivadnya17@gmail.com', 'Jal Suchana');
...
if (!$mail->send()) {
    ...
    echo '<script>alert("Email sent successfully!");window.location="home.php";</script>';
}
