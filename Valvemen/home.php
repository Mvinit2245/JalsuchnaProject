        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                ...
                <div class="col-lg-12">
                 ...
                 <hr>
                 <button type="button" class="btn btn-outline-dark waves-effect waves-light ">28/03/2023</button>
                 <button type="button" class="btn btn-outline-dark waves-effect waves-light ">Tuesday</button>
                 <hr>
