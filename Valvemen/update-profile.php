...
<div class="form-group row">
        <label class="col-lg-3 col-form-label form-control-label">ValvemenID</label>
        <div class="col-lg-9">
            <input class="form-control" name="valve_id" type="text" value="<?php echo $valman['ValvemenID'];?>" disabled>
        </div>
    </div>
    <div class="form-group row">
        <label class="col-lg-3 col-form-label form-control-label">Name</label>
        <div class="col-lg-9">
            <input class="form-control" name="val_name" type="text" value="<?php echo $valman['Name'];?>">
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-lg-9">
            <input class="form-control" name="val_mob" type="text"  value="<?php echo $valman['Mobile'];?>">
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-lg-9">
            <input class="form-control" name="val_mail" type="email" value="<?php echo $valman['Email'];?>">
        </div>
    </div>

    <div class="form-group row">
        <label class="col-lg-3 col-form-label form-control-label">ResidentialArea</label>
        <div class="col-lg-7">
        <select name="u_res" class="form-control" name="val_res" id="basic-select" value="">
...
?>
    ...
    <div class="form-group row">
        <label class="col-lg-3 col-form-label form-control-label">ConfirmPassword</label>
        <div class="col-lg-9">
            <input class="form-control" type="text" value="Vaibhav123">
        </div>
    </div> -->
